...
class Entity:
    def __init__(self, x, y, char, colour, name, block_movement=False, render_order=RenderOrder.CORPSE, combatant=None, ai=None, item=None, inventory=None, stairs=None, level=None, equipment=None, equippable=None):
        self.x=x
        self.y=y
        self.char=char
        self.colour=colour
